...
Записать и выйти вводим ``:qw`` если выход без записи ``:q`` 
...
Как установить статичесий IP адрес? Открываем тот же файл конфигурации ``vi /etc/sysconfig/network-scripts/ifcfg-eno1`` <br>
и прописываем параметры в ручную.

...
по умолчанию сетевой интерфейс был выключен, включаем его и прописываем динамическое получение IP адреса. Чтобы внести изменения переходим в режим ввода, нажатием клавиши ``i``  Insert.

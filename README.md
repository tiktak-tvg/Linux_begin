...
##### Модуль 1. Знакомство с командами системой помощи и оболочкой UNIX<br>
- man
- --help
- info
...
### Модуль 2. Переменные окружения и встроенные команды bash.<br>
```
...
### Модуль 3. Повышение привилегий до суперпользователя.<br>
...
##### Модуль 4. Управление правами доступа.<br>

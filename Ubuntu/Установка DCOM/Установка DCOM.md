```
Установка и удаление программы в операционных системах семейства Linux
...
# Для того чтобы работал ярлык на DCOM, который находится в папке DCOM требуется дать разрешение 
# на папку DICOMViewerWorkspace по пути /home/user/DICOMViewerWorkspace
